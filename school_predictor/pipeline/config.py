...
class PipelinePaths:
    ...
    def from_project_root(cls, project_root: str | Path, min_history: int = 2, mode: str = "default") -> "PipelinePaths":
        ...
        output_dir = project_paths.pipeline_artifacts_dir / mode
        return cls(
            mode=mode,
            project_root=root,
            school_report_dir=project_paths.reports_artifacts_dir,
            grades_csv=project_paths.csv_dir / "media_nota_aluno.csv",
            absences_csv=project_paths.csv_dir / "faltas_aluno.csv",
            payments_csv=project_paths.csv_dir / "pagamento_aluno.csv",
            teachers_csv=project_paths.csv_dir / "professor_disciplina.csv",
