...
Os dados utilizados s\~ao provenientes de uma base escolar real contendo registros de alunos, notas, faltas, pagamentos e informa\c{c}\~oes acad\^emicas e administrativas. A base foi atualizada at\'e abril de 2026 e passou por um processo de manuten\c{c}\~ao para uso acad\^emico. Esse fluxo incluiu renomea\c{c}\~ao da base, redu\c{c}\~ao estrutural, reorganiza\c{c}\~ao de \'indices, atualiza\c{c}\~ao de estat\'isticas e anonimiza\c{c}\~ao dos registros sens\'iveis.
