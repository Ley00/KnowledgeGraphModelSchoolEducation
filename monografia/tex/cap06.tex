...
Em termos quantitativos, o modo de previs\~ao num\'erica atingiu \textit{MAE} de 0,7601, enquanto o modo de alerta de risco alcan\c{c}ou \textit{F1} de 0,7437 e \textit{recall} de 0,8618 no teste temporal. Em termos pr\'aticos, esses resultados indicam que a solu\c{c}\~ao j\'a pode servir como mecanismo de triagem e prioriza\c{c}\~ao institucional, desde que usada com supervis\~ao humana e interpreta\c{c}\~ao contextualizada.
